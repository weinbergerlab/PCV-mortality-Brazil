...
input_directory  <- './Mortality/' #Directory (or URL) containing input data file.
...
file_name        <- 'national.csv'                                                                       #Name of file containing data for analysis. Must be a .csv file.
